...
mpiexec -n 48 ./build/src/distributed_cpu/dist_cpu input.raw output.raw 6000 6000 36
mpiexec -n 64 ./build/src/distributed_cpu/dist_cpu input.raw output.raw 6000 6000 36
...
mpiexec -n 48 ./build/src/distributed_gpu/dist_gpu input.raw output.raw 6000 6000 36
mpiexec -n 64 ./build/src/distributed_gpu/dist_gpu input.raw output.raw 6000 6000 36